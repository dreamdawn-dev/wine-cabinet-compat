...
| `dreamdawn:double_bottle_wine` | 双瓶大酒标签：#dreamdawn:large_bottle_wine的延申，在 Kaleidoscope Tavern 的 bar_cabinet / glass_bar_cabinet 两个大酒柜中允许左右各放一瓶（同小瓶酒），其余场景仍按大瓶酒处理（要同时打上大酒瓶标签才生效） |
